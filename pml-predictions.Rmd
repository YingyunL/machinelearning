...
In this report we try to predict the manners of exercises from recorded parameters. First, variables useful in prediction were selected from all the available variables using principle component analysis. A model was then built using a training data set with these variables. Cross validation was applied, and the out of sample error was estimated. Finally, the model was used to predict the manners of exercises for 20 cases of test data. 
